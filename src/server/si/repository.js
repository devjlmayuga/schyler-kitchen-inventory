...
export const saveFaceProfile = adapter.saveFaceProfile;
export const listFaceProfiles = adapter.listFaceProfiles;
export const removeFaceProfile = adapter.removeFaceProfile;
export const recordFaceAttendance = adapter.recordFaceAttendance;
export const listFaceAttendanceWeek = adapter.listFaceAttendanceWeek;
